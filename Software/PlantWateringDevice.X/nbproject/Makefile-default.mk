...
FINAL_IMAGE=${DISTDIR}/PlantWateringDevice.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/PlantWateringDevice.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC10F202
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/PlantWateringDevice.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/PlantWateringDevice.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC10F202 ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/PlantWateringDevice.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
