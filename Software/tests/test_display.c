...
/**
 * @brief Verify overflow pulse triggers additional pulse request.
 *
 * @par Scenario:
 ...
 *  - Output becomes LOW.
 *  - sending_pulse_to_display cleared.
 *  - display_overflow_pulse cleared.
 *  - send_pulse_to_display set (triggers next pulse).
 */
void test_overflow_pulse_triggers_additional_pulse(void)
{
    data.sending_pulse_to_display = true;
...
/**
 * @brief Verify full overflow sequence generates two complete pulses.
 *
 * @par Scenario:
 ...
 *  - Tick 2: LOW (first pulse end), triggers second pulse request
 *  - Tick 3: HIGH (second pulse start)
 *  - Tick 4: LOW (second pulse end)
 *  - All flags cleared.
 */
void test_full_overflow_pulse_sequence(void)
{
    data.send_pulse_to_display = true;
    data.display_overflow_pulse = true;
...
int main(void)
{
    ...
    RUN_TEST(test_overflow_pulse_triggers_additional_pulse);
    RUN_TEST(test_full_overflow_pulse_sequence);
